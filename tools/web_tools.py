...
def _get_backend() -> str:
    ...
    if configured in {"parallel", "firecrawl", "tavily", "exa", "searxng", "brave-free", "ddgs", "xai", "apify"}:
        return configured
...
def _is_backend_available(backend: str) -> bool:
    ...
    if backend == "xai":
        ...
        try:
            ...
            return False
    if backend == "apify":
        return _has_env("APIFY_API_TOKEN")
    return False
...
def check_web_api_key() -> bool:
    ...
    if configured in {"exa", "parallel", "firecrawl", "tavily", "searxng", "brave-free", "ddgs", "apify"}:
        return _is_backend_available(configured)
    return any(
        _is_backend_available(backend)
        for backend in ("exa", "parallel", "firecrawl", "tavily", "searxng", "brave-free", "ddgs", "apify")
    )
